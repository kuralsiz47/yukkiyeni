...
async def initiate_bot():    
    ...
    with console.status(
        "[magenta] Talia Winamp Bot Önyükleme bilgisi...",
    ) as status:
        console.print("┌ [red]İstemcileri önyükmesi güncelleniyor...\n")
        await app.start()
        console.print("└ [green]Önyüklenen Bot İstemcisi")
        console.print("\n┌ [red]Yardımcı istemciler başlatıyor...")
        if STRING1 != "None":
        ...
        if LOG_SESSION != "None":
            ...
            console.print("└ [green]Günlükçü İstemcisi Başarıyla Önyüklendi!")
